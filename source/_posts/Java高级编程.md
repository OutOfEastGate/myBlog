...
2. 作用：提供流的读取、写入的速度
   ...
   ![image-20211129121012675](/img/Java高级编程.assets/image-20211129121012675.png)
...
3. 图示：
   ...
   ![image-20211129121229736](/img/Java高级编程.assets/image-20211129121229736.png)
...
2. Path的使用 ---jdk7提供
   ...
   2. 如何实例化：
      ...
      ![image-20211129122228546](/img/Java高级编程.assets/image-20211129122228546.png)

   3. 常用方法：

      ![image-20211129122238238](/img/Java高级编程.assets/image-20211129122238238.png)
...
3. Files工具类 ---jdk7提供
   ...
   2. 常用方法
      ...
      ![image-20211129122311124](/img/Java高级编程.assets/image-20211129122311124.png)

      ![image-20211129122315352](/img/Java高级编程.assets/image-20211129122315352.png)
...
4. 通信要素二：网络通信协议
   ...
   1. 分型模型
      ...
      ![image-20211129123458561](/img/Java高级编程.assets/image-20211129123458561.png)

      

   2. TCP和UDP的区别

      ![image-20211129123507792](/img/Java高级编程.assets/image-20211129123507792.png)

   3. TCP三次握手和四次挥手

      ![image-20211129123518762](/img/Java高级编程.assets/image-20211129123518762.png)

      ![image-20211129123522815](/img/Java高级编程.assets/image-20211129123522815.png)
...
4. 常用方法：
   ...
   ![image-20211129123826018](/img/Java高级编程.assets/image-20211129123826018.png)
...
1. 本章的主要内容
   ...
   ![image-20211129123911661](/img/Java高级编程.assets/image-20211129123911661.png)
...
4. 反射机制能提供的功能
   ...
   ![image-20211129124016535](/img/Java高级编程.assets/image-20211129124016535.png)
...
4. Class实例可以是哪些结构的说明
   ...
   ![image-20211129124227257](/img/Java高级编程.assets/image-20211129124227257.png)

### 了解ClassLoader

1. 类的加载过程----了解

   ![image-20211129124249502](/img/Java高级编程.assets/image-20211129124249502.png)

2. 类的加载器的作用

   ![image-20211129124304756](/img/Java高级编程.assets/image-20211129124304756.png)

3. 类的加载器的分类

   ![image-20211129124314971](/img/Java高级编程.assets/image-20211129124314971.png)

4. Java类编译、运行的执行的流程

   ![image-20211129124325393](/img/Java高级编程.assets/image-20211129124325393.png)
...
![image-20211129125029856](/img/Java高级编程.assets/image-20211129125029856.png)

![image-20211129125034325](/img/Java高级编程.assets/image-20211129125034325.png)
...
3. 如何使用：分为六种情况
   ...
   ![image-20211129125408541](/img/Java高级编程.assets/image-20211129125408541.png)

   ![image-20211129125413572](/img/Java高级编程.assets/image-20211129125413572.png)
...
2. Java8中关于Lambda表达式提供的4个基本的函数式接口：具体使用：
   ...
   ![image-20211129125538650](/img/Java高级编程.assets/image-20211129125538650.png)
...
6. 步骤二：中间操作
   ...
   ![image-20211129144053418](/img/Java高级编程.assets/image-20211129144053418.png)

   ![image-20211129144057919](/img/Java高级编程.assets/image-20211129144057919.png)

   ![image-20211129144101495](/img/Java高级编程.assets/image-20211129144101495.png)

   

7. 步骤三：终止操作

   ![image-20211129144113249](/img/Java高级编程.assets/image-20211129144113249.png)

   ![image-20211129144117317](/img/Java高级编程.assets/image-20211129144117317.png)

   ![image-20211129144122002](/img/Java高级编程.assets/image-20211129144122002.png)

   ![image-20211129144127387](/img/Java高级编程.assets/image-20211129144127387.png)

   Collector需要使用Collectors提供实例。

   ![image-20211129144145871](/img/Java高级编程.assets/image-20211129144145871.png)
